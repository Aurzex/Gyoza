...
export function BackToTopFAB() {
  ...
  return (
    <div className="fixed right-4 bottom-6 z-10">
      <button
        className={clsx(
          'size-10 rounded-full shadow-lg shadow-zinc-800/5 border border-primary bg-white/50 dark:bg-zinc-800/50 backdrop-blur transition-[opacity,transform] duration-300 hover:scale-110 hover:shadow-xl hover:shadow-zinc-800/15',
